...
export default function CreateShipmentModal({ isOpen, onClose, onSave }) {
      ...
      <DialogContent className="max-w-6xl max-h-[95vh] overflow-hidden">
        <DialogHeader>
          <DialogTitle className="flex items-center space-x-2">
            ...
            <span>Create Shipment Order</span>
          </DialogTitle>
          <DialogDescription>Create a new shipment order with multiple SKU items</DialogDescription>
        </DialogHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select value={shipmentOrder.brand} onValueChange={(value) => handleShipmentChange("brand", value)}>
                ...
                <div className="bg-blue-50 dark:bg-blue-950 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-blue-900 dark:text-blue-100">{totalQty.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-blue-800 dark:text-blue-200">Total GMV:</span>
                      <span className="font-medium text-blue-900 dark:text-blue-100">₹{totalGmv.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between">
