...
export const master_channel_location_mapping = {
    "Amazon": [
      {location:"AMD2",	drop_location: "Ahmedabad",},
      {location:"ATX1",	drop_location: "Ludhiana",},
      {location:"BLR7",	drop_location: "Bangalore",},
      {location:"BLR8",	drop_location: "Bangalore",},
      {location:"BOM5",	drop_location: "Mumbai",},
      {location:"BOM7",	drop_location: "Mumbai",},
      {location:"CCX1",	drop_location: "Kolkata",},
      {location:"CJB1",	drop_location: "Chennai",},
      {location:"DEL4",	drop_location: "Delhi NCR",}, 
      {location:"DEL5",	drop_location: "Delhi NCR",}, 
      {location:"DEX3",	drop_location: "Delhi NCR",}, 
      {location:"DEX8",	drop_location: "Delhi NCR",}, 
      {location:"GAX1",	drop_location: "Guwahati",},
      {location:"HYD3",	drop_location: "Hyderabad",},
      {location:"HYD8",	drop_location: "Hyderabad",},
      {location:"JPX1",	drop_location: "Jaipur",},
      {location:"JPX2",	drop_location: "Jaipur",},
      {location:"LKO1",	drop_location: "Lucknow",},
      {location:"MAA4",	drop_location: "Chennai",},
      {location:"PAX1",	drop_location: "Patna",},
      {location:"PNQ2",	drop_location: "Pune",},
      {location:"PNQ3",	drop_location: "Pune",},
      {location:"SIDA",	drop_location: "SIDA",},
      {location:"CCU1",	drop_location: "Calicut",},
      {location:"RSOC",	drop_location: "Kolkata",},
      {location:"REOB",	drop_location: "REOB",},
      {location:"RSO7",	drop_location: "Mumbai",},
      {location:"RSO8",	drop_location: "RSO8",},
      {location:"RSO6",	drop_location: "RSO6",},
      {location:"RSXE",	drop_location: "RSXE",},
      {location:"CCX2",	drop_location: "Kolkata",},
    ],
