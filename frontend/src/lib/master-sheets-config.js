...
export const MASTER_SHEETS_CONFIG = {
    ...
    courierPartner: {
        ...
        expectedColumns:
            ...
            { label: "Appointment Charge (Appointment Channel Yes)", key: "appointmentChargeYes", type: "number" },
            { label: "Appointment Charge (Appointment Channel No)", key: "appointmentChargeNo", type: "number" },
    ...
    status: {
        ...
        expectedColumns:
            ...
            { label: "Status (Final Status)", key: "statusFinal", type: "string" },
            ],
    ...
    appointmentRemarks: {
        ...
        expectedColumns:
            [{ label: "Appointment Change Remarks", key: "remark", type: "string" },
            { label: "Appointment Change Category", key: "category", type: "string" },
            ],
